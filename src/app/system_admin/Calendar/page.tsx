      ...
      const mockEvents: CalendarEvent[] = [
        {
          ...
          description: "Process March 2026 payroll for all organizations",
          date: "2026-03-31",
          time: "09:00 AM",
          type: "payroll",
        ...
        },
        {
          ...
          description: "Quarterly tax filing deadline for all organizations",
          date: "2026-04-15",
          time: "11:59 PM",
          type: "deadline",
          status: "upcoming"
        ...
        },
        {
          id: "evt_004",
          title: "Good Friday",
          description: "Public holiday - No payroll processing",
          date: "2026-04-18",
          time: "All Day",
          type: "holiday",
          status: "upcoming"
        ...
        {
          id: "evt_005",
          title: "Biweekly Payroll - Org 2",
          description: "Biweekly payroll processing for Marketing Agency",
          date: "2026-03-22",
          time: "10:00 AM",
          type: "payroll",
        ...
        },
        {
          id: "evt_006",
          title: "Admin Meeting",
          description: "Monthly system admin review meeting",
          date: "2026-03-28",
          time: "03:00 PM",
          type: "meeting",
          status: "upcoming"
                    ...
                    <tr key={event.id}>
                      ...
                      <td>
                        <span className="organization">
                          {event.organizationName || 'System-wide'}
                        </span>
                      </td>
                      <td>
                        <span className={`status-badge ${getStatusColor(event.status)}`}>
                ...
                <div className="event-details">
                  ...
                  <div className="detail-row">
                    ...
                    <span className="detail-value">
                      {selectedEvent.organizationName || 'System-wide'}
                    </span>
                  </div>
                  <div className="detail-row">
